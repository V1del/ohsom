...
public class BLNachrichten {
	...
	/**
	 * Methode zur Ver‰nderung von Nachrichten (Update in der Datenbank)
	 * @param Nachricht
	 * @return Konnte die Nachricht erfolgreich ver‰ndert werden?
	 * @throws SQLException
	 */
	...
	/**
	 * Methode zur Lˆschung von Nachrichten (Delete in der Datenbank)
	 * @param Nachricht
	 * @return Konnte die Nachricht erfolgreich gelˆscht werden?
	 * @throws SQLException
	 */
