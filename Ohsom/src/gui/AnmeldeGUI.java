...
public class AnmeldeGUI extends JFrame implements ActionListener, KeyListener {
	...
	/**
	 * orrektheit der Eingaben von der Datenbank her (ist der Account �berhaupt  erstellbar, Nickname vorhanden?)
	 * @throws SQLException
	 */
	...
	/** 
	 * �nderung des Labels f�r Passwortsicherheit
	 */
	public void RefreshPasswordSecurityPB()
	{
		...
		case 1:
			...
			break;
		case 2:
			lblPasswortStaerke.setText("m�ssig");
			break;
		case 3:
