...
public class TamagotchiGUI implements ActionListener, KeyListener{
	...
	private void initialize() throws SQLException {
		...
		lblMuedigkeitValue = new JLabel("valM�de");
	...
	/**
	 * ActionEvents f�r TamagotchiGui
	 */
	...
	public void washTamagotchi() throws SQLException
	{
		if(blT.washTamagotchi())
		{
			...
			setEreignisLabel("Dein Tamagotchi ist nun sch�n sauber");
		}
		else
		{
	...
	public void layTamagotchiToSleep() throws SQLException
	{
		if(blT.layTamagotchiToSleep()) {
			setEreignisLabel("Dein Tamagotchi schl�ft nun");
		}
		else
		{
			setEreignisLabel("Dein Tamagotchi ist nicht m�de");
		}
	}
	...
	/**
	 * Setzen des Ereignislabels bei jeder Ver�nderung
	 * @param Meldung
	 */
