...
public class TamagotchiGUI extends JFrame implements ActionListener, KeyListener{
	...
	/**
	 * Bef�llen des TamagotchiButtons - Panels
	 * @throws SQLException
	 */
	...
	/**
	 * Refresh Tamagotchi Panel nach Ablauf des Timers um immer wieder den Zustand zu �berpr�fen
	 * @throws SQLException
	 */
